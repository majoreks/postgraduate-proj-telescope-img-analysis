...
def plotFITSImageWithBoundingBoxes(image_data_, labels_ground_truth, labels_predictions = None, output_path='output', save_fig: bool = False, save_fig_sufix:str=None, title_sufix:str = None) -> None:
    """
